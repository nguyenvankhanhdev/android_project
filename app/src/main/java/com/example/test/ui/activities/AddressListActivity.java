...
public class AddressListActivity extends BaseActivity {
    ...
    private void getAddressList() {
        ...
        new FirestoreClass().getAddressesList(AddressListActivity.this);
    }
        ...
        if (addressList.size() > 0) {
            ...
            if (!mSelectAddress) {
                ...
                SwipeToDeleteCallback deleteSwipeHandler = new SwipeToDeleteCallback(AddressListActivity.this) {
                    ...
                    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                        showProgressDialog(getResources().getString(R.string.please_wait));
                        new FirestoreClass().deleteAddress(AddressListActivity.this, addressList.get(viewHolder.getAdapterPosition()).getId());
                    }
                };
