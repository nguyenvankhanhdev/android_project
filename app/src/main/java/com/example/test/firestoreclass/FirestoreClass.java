...
public class FirestoreClass {
    ...
    public void updateUserProfileData(Activity activity, HashMap<String, Object> userHashMap) {
        ...
        .addOnFailureListener(e -> {
            ...
            Log.e(activity.getClass().getSimpleName(), "Error while updating the user details.", e);
        });
    }
    public void uploadImageToCloudStorage(final Activity activity, Uri imageFileURI, String imageType) {
    ...
    public void getProductsList(Fragment fragment) {
    ...
    public void deleteProduct(ProductsFragment fragment, String productId) {
        mFireStore.collection(Constants.PRODUCTS)
            .document(productId)
            .delete()
            .addOnSuccessListener(aVoid -> fragment.productDeleteSuccess())
        .addOnFailureListener(e -> {
            fragment.hideProgressDialog();
            Log.e(fragment.requireActivity().getClass().getSimpleName(), "Error while deleting the product.", e);
        });
    }
                            ...
                            if (product != null) {
                                mFireStore.collection(Constants.SIZE_PRODUCTS)
                                        ...
                                        .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                                            @Override
                                            public void onSuccess(QuerySnapshot sizeQuerySnapshot) {
                                                Map<String, Long> sizeQuantityMap = new HashMap<>();
                                                for (DocumentSnapshot sizeDocument : sizeQuerySnapshot.getDocuments()) {
                                                    SizeProduct sizeProduct = sizeDocument.toObject(SizeProduct.class);
                                                    if (sizeProduct != null) {
                                                        sizeQuantityMap.put(String.valueOf(sizeProduct.getSize()), (long) sizeProduct.getQuantity());
                                                    }
                                                }
                                        ...
                                        .addOnFailureListener(new OnFailureListener() {
                                            ...
                                            public void onFailure(Exception e) {
                                                activity.hideProgressDialog();
                                                Log.e(activity.getClass().getSimpleName(), "Error while getting size product details.", e);
                                            }
                                        });
                            }
                        } else {
                            activity.hideProgressDialog();
                            activity.showErrorSnackBar(activity.getResources().getString(R.string.err_msg_product_not_found), true);
                        }
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(Exception e) {
                        activity.hideProgressDialog();
                        Log.e(activity.getClass().getSimpleName(), "Error while getting product details.", e);
                    }
                });
    }
    ...
    public void checkIfItemExistInCart(ProductDetailsActivity activity, String productId) {
        mFireStore.collection(Constants.CART_ITEMS)
            ...
            .get()
            .addOnSuccessListener((QuerySnapshot documentSnapshot) -> {
            Log.e(activity.getClass().getSimpleName(), documentSnapshot.getDocuments().toString());
        ...
        .addOnFailureListener(e -> {
            activity.hideProgressDialog();
            Log.e(activity.getClass().getSimpleName(), "Error while checking the existing cart list.", e);
        });
    }
    ...
    public void deleteAddress(AddressListActivity activity, String addressId) {

        mFireStore.collection(Constants.ADDRESSES)
            .document(addressId)
            .delete()
            .addOnSuccessListener(aVoid -> activity.deleteAddressSuccess())
        .addOnFailureListener(e -> {
            activity.hideProgressDialog();
    ...
    public void getMyOrdersList(OrdersFragment fragment) {
        mFireStore.collection(Constants.ORDERS)
            ...
            for (DocumentSnapshot i : document.getDocuments()) {
            Order orderItem = i.toObject(Order.class);
            if (orderItem != null) {
                orderItem.setId(i.getId());
                list.add(orderItem);
            }
        }
        ...
        .addOnFailureListener(e -> {
            fragment.hideProgressDialog();
            Log.e(fragment.getClass().getSimpleName(), "Error while getting the orders list.", e);
        });
    }
    ...
    public void getSoldProductsList(SoldProductsFragment fragment) {
        mFireStore.collection(Constants.SOLD_PRODUCTS)
            ...
            for (DocumentSnapshot i : document.getDocuments()) {
            SoldProduct soldProduct = i.toObject(SoldProduct.class);
            if (soldProduct != null) {
                soldProduct.setId(i.getId());
        ...
        .addOnFailureListener(e -> {
            fragment.hideProgressDialog();
            Log.e(fragment.getClass().getSimpleName(), "Error while getting the list of sold products.", e);
        });
    }
